...
#let report-introduction(section, report) = [
  ...
  #page(margin: (x: 0pt))[
    ...
    #gut-microbiome-species-tab(
      ...
      rgb("B83143"),
      [有害菌是對健康產生負面影響的微生物，典型的如大腸桿菌和沙門氏菌。這些細菌在腸道中可能導致感染\ 、炎症及消化不良等問題。雖然有害菌在生態系統中扮演著清除死細胞等角色，但其數量過多會對健康產生威脅，因此應控制在適當水平。], // hack: force new line before justifying Chinese is fixed
    )
